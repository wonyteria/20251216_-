    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white dark:bg-slate-900 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl animate-in fade-in zoom-in duration-200 no-scrollbar">
                ...
                {/* Profile Completion Modal for General/Crew items */}
                {/* Render it again if needed or just once at root? 
        Since there are two return paths (MindDate vs Others), I need to place it in both or restructure.
        Currently I placed it in MindDate return, but need it here too.
    */}
                {currentUser && (
                    <ProfileCompletionModal
                        isOpen={showProfileModal}
